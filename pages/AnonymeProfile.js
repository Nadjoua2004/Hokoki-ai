...
const AnonymeProfile = ({ route, navigation }) => {
    const { lawyer, anonymousName } = route.params;
    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <View style={styles.photoContainer}>
          ...
          />
          <Text style={styles.lawyerName}>{anonymousName}</Text>
